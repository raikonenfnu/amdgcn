...
enum hip_api_id_t {
  ...
  HIP_API_ID_hipDrvMemcpy2DUnaligned = 7,
  HIP_API_ID_hipExtStreamGetCUMask = 8,
  HIP_API_ID_hipEventRecord = 9,
  HIP_API_ID_hipCtxSynchronize = 10,
  HIP_API_ID_hipSetDevice = 11,
  HIP_API_ID_hipCtxGetApiVersion = 12,
  HIP_API_ID_hipMemcpyFromSymbolAsync = 13,
  HIP_API_ID_hipExtGetLinkTypeAndHopCount = 14,
  HIP_API_ID___hipPopCallConfiguration = 15,
  HIP_API_ID_hipModuleOccupancyMaxActiveBlocksPerMultiprocessor = 16,
  HIP_API_ID_hipMemset3D = 17,
  HIP_API_ID_hipStreamCreateWithPriority = 18,
  HIP_API_ID_hipMemcpy2DToArray = 19,
  HIP_API_ID_hipMemsetD8Async = 20,
  HIP_API_ID_hipCtxGetCacheConfig = 21,
  HIP_API_ID_hipModuleGetFunction = 22,
  HIP_API_ID_hipStreamWaitEvent = 23,
  HIP_API_ID_hipDeviceGetStreamPriorityRange = 24,
  HIP_API_ID_hipModuleLoad = 25,
  HIP_API_ID_hipDevicePrimaryCtxSetFlags = 26,
  HIP_API_ID_hipArrayDestroy = 27,
  HIP_API_ID_hipLaunchCooperativeKernel = 28,
  HIP_API_ID_hipLaunchCooperativeKernelMultiDevice = 29,
  HIP_API_ID_hipMemcpyAsync = 30,
  HIP_API_ID_hipMalloc3DArray = 31,
  HIP_API_ID_hipMallocHost = 32,
  HIP_API_ID_hipCtxGetCurrent = 33,
  HIP_API_ID_hipDevicePrimaryCtxGetState = 34,
  HIP_API_ID_hipEventQuery = 35,
  HIP_API_ID_hipStreamWaitValue64 = 36,
  HIP_API_ID_hipEventCreate = 37,
  HIP_API_ID_hipMemGetAddressRange = 38,
  HIP_API_ID_hipStreamWriteValue32 = 39,
  HIP_API_ID_hipMemcpyFromSymbol = 40,
  HIP_API_ID_hipArrayCreate = 41,
  HIP_API_ID_hipStreamAttachMemAsync = 42,
  HIP_API_ID_hipStreamGetFlags = 43,
  HIP_API_ID_hipMallocArray = 44,
  HIP_API_ID_hipCtxGetSharedMemConfig = 45,
  HIP_API_ID_hipDeviceDisablePeerAccess = 46,
  HIP_API_ID_hipModuleOccupancyMaxPotentialBlockSize = 47,
  HIP_API_ID_hipMemPtrGetInfo = 48,
  HIP_API_ID_hipFuncGetAttribute = 49,
  HIP_API_ID_hipCtxGetFlags = 50,
  HIP_API_ID_hipStreamDestroy = 51,
  HIP_API_ID___hipPushCallConfiguration = 52,
  HIP_API_ID_hipMemset3DAsync = 53,
  HIP_API_ID_hipDeviceGetPCIBusId = 54,
  HIP_API_ID_hipInit = 55,
  HIP_API_ID_hipMemcpyAtoH = 56,
  HIP_API_ID_hipStreamGetPriority = 57,
  HIP_API_ID_hipMemset2D = 58,
  HIP_API_ID_hipMemset2DAsync = 59,
  HIP_API_ID_hipDeviceCanAccessPeer = 60,
  HIP_API_ID_hipLaunchByPtr = 61,
  HIP_API_ID_hipMemPrefetchAsync = 62,
  HIP_API_ID_hipCtxDestroy = 63,
  HIP_API_ID_hipMemsetD16Async = 64,
  HIP_API_ID_hipModuleUnload = 65,
  HIP_API_ID_hipHostUnregister = 66,
  HIP_API_ID_hipProfilerStop = 67,
  HIP_API_ID_hipExtStreamCreateWithCUMask = 68,
  HIP_API_ID_hipStreamSynchronize = 69,
  HIP_API_ID_hipFreeHost = 70,
  HIP_API_ID_hipDeviceSetCacheConfig = 71,
  HIP_API_ID_hipGetErrorName = 72,
  HIP_API_ID_hipMemcpyHtoD = 73,
  HIP_API_ID_hipModuleGetGlobal = 74,
  HIP_API_ID_hipMemcpyHtoA = 75,
  HIP_API_ID_hipCtxCreate = 76,
  HIP_API_ID_hipMemcpy2D = 77,
  HIP_API_ID_hipIpcCloseMemHandle = 78,
  HIP_API_ID_hipChooseDevice = 79,
  HIP_API_ID_hipDeviceSetSharedMemConfig = 80,
  HIP_API_ID_hipMallocMipmappedArray = 81,
  HIP_API_ID_hipSetupArgument = 82,
  HIP_API_ID_hipIpcGetEventHandle = 83,
  HIP_API_ID_hipFreeArray = 84,
  HIP_API_ID_hipCtxSetCacheConfig = 85,
  HIP_API_ID_hipFuncSetCacheConfig = 86,
  HIP_API_ID_hipLaunchKernel = 87,
  HIP_API_ID_hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags = 88,
  HIP_API_ID_hipModuleGetTexRef = 89,
  HIP_API_ID_hipFuncSetAttribute = 90,
  HIP_API_ID_hipEventElapsedTime = 91,
  HIP_API_ID_hipConfigureCall = 92,
  HIP_API_ID_hipMemAdvise = 93,
  HIP_API_ID_hipMemcpy3DAsync = 94,
  HIP_API_ID_hipEventDestroy = 95,
  HIP_API_ID_hipCtxPopCurrent = 96,
  HIP_API_ID_hipGetSymbolAddress = 97,
  HIP_API_ID_hipHostGetFlags = 98,
  HIP_API_ID_hipHostMalloc = 99,
  HIP_API_ID_hipCtxSetSharedMemConfig = 100,
  HIP_API_ID_hipFreeMipmappedArray = 101,
  HIP_API_ID_hipMemGetInfo = 102,
  HIP_API_ID_hipDeviceReset = 103,
  HIP_API_ID_hipMemset = 104,
  HIP_API_ID_hipMemsetD8 = 105,
  HIP_API_ID_hipMemcpyParam2DAsync = 106,
  HIP_API_ID_hipHostRegister = 107,
  HIP_API_ID_hipDriverGetVersion = 108,
  HIP_API_ID_hipArray3DCreate = 109,
  HIP_API_ID_hipIpcOpenMemHandle = 110,
  HIP_API_ID_hipStreamWaitValue32 = 111,
  HIP_API_ID_hipGetLastError = 112,
  HIP_API_ID_hipGetDeviceFlags = 113,
  HIP_API_ID_hipDeviceGetSharedMemConfig = 114,
  HIP_API_ID_hipDrvMemcpy3D = 115,
  HIP_API_ID_hipMemcpy2DFromArray = 116,
  HIP_API_ID_hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags = 117,
  HIP_API_ID_hipSetDeviceFlags = 118,
  HIP_API_ID_hipHccModuleLaunchKernel = 119,
  HIP_API_ID_hipFree = 120,
  HIP_API_ID_hipOccupancyMaxPotentialBlockSize = 121,
  HIP_API_ID_hipDeviceGetAttribute = 122,
  HIP_API_ID_hipDeviceComputeCapability = 123,
  HIP_API_ID_hipCtxDisablePeerAccess = 124,
  HIP_API_ID_hipMallocManaged = 125,
  HIP_API_ID_hipDeviceGetByPCIBusId = 126,
  HIP_API_ID_hipIpcGetMemHandle = 127,
  HIP_API_ID_hipMemcpyHtoDAsync = 128,
  HIP_API_ID_hipCtxGetDevice = 129,
  HIP_API_ID_hipMemcpyDtoD = 130,
  HIP_API_ID_hipModuleLoadData = 131,
  HIP_API_ID_hipDevicePrimaryCtxRelease = 132,
  HIP_API_ID_hipOccupancyMaxActiveBlocksPerMultiprocessor = 133,
  HIP_API_ID_hipCtxSetCurrent = 134,
  HIP_API_ID_hipGetErrorString = 135,
  HIP_API_ID_hipStreamCreate = 136,
  HIP_API_ID_hipDevicePrimaryCtxRetain = 137,
  HIP_API_ID_hipDeviceGet = 138,
  HIP_API_ID_hipStreamCreateWithFlags = 139,
  HIP_API_ID_hipMemcpyFromArray = 140,
  HIP_API_ID_hipMemcpy2DAsync = 141,
  HIP_API_ID_hipFuncGetAttributes = 142,
  HIP_API_ID_hipGetSymbolSize = 143,
  HIP_API_ID_hipHostFree = 144,
  HIP_API_ID_hipEventCreateWithFlags = 145,
  HIP_API_ID_hipStreamQuery = 146,
  HIP_API_ID_hipMemcpy3D = 147,
  HIP_API_ID_hipMemcpyToSymbol = 148,
  HIP_API_ID_hipMemcpy = 149,
  HIP_API_ID_hipStreamWriteValue64 = 150,
  HIP_API_ID_hipPeekAtLastError = 151,
  HIP_API_ID_hipExtLaunchMultiKernelMultiDevice = 152,
  HIP_API_ID_hipHostAlloc = 153,
  HIP_API_ID_hipStreamAddCallback = 154,
  HIP_API_ID_hipMemcpyToArray = 155,
  HIP_API_ID_hipMemsetD32 = 156,
  HIP_API_ID_hipExtModuleLaunchKernel = 157,
  HIP_API_ID_hipDeviceSynchronize = 158,
  HIP_API_ID_hipDeviceGetCacheConfig = 159,
  HIP_API_ID_hipMalloc3D = 160,
  HIP_API_ID_hipPointerGetAttributes = 161,
  HIP_API_ID_hipMemsetAsync = 162,
  HIP_API_ID_hipDeviceGetName = 163,
  HIP_API_ID_hipModuleOccupancyMaxPotentialBlockSizeWithFlags = 164,
  HIP_API_ID_hipCtxPushCurrent = 165,
  HIP_API_ID_hipMemcpyPeer = 166,
  HIP_API_ID_hipEventSynchronize = 167,
  HIP_API_ID_hipMemcpyDtoDAsync = 168,
  HIP_API_ID_hipProfilerStart = 169,
  HIP_API_ID_hipExtMallocWithFlags = 170,
  HIP_API_ID_hipCtxEnablePeerAccess = 171,
  HIP_API_ID_hipMemAllocHost = 172,
  HIP_API_ID_hipMemcpyDtoHAsync = 173,
  HIP_API_ID_hipModuleLaunchKernel = 174,
  HIP_API_ID_hipMemAllocPitch = 175,
  HIP_API_ID_hipExtLaunchKernel = 176,
  HIP_API_ID_hipMemcpy2DFromArrayAsync = 177,
  HIP_API_ID_hipDeviceGetLimit = 178,
  HIP_API_ID_hipModuleLoadDataEx = 179,
  HIP_API_ID_hipRuntimeGetVersion = 180,
  HIP_API_ID_hipMemRangeGetAttribute = 181,
  HIP_API_ID_hipDeviceGetP2PAttribute = 182,
  HIP_API_ID_hipMemcpyPeerAsync = 183,
  HIP_API_ID_hipGetDeviceProperties = 184,
  HIP_API_ID_hipMemcpyDtoH = 185,
  HIP_API_ID_hipMemcpyWithStream = 186,
  HIP_API_ID_hipDeviceTotalMem = 187,
  HIP_API_ID_hipHostGetDevicePointer = 188,
  HIP_API_ID_hipMemRangeGetAttributes = 189,
  HIP_API_ID_hipMemcpyParam2D = 190,
  HIP_API_ID_hipDevicePrimaryCtxReset = 191,
  HIP_API_ID_hipGetMipmappedArrayLevel = 192,
  HIP_API_ID_hipMemsetD32Async = 193,
  HIP_API_ID_hipGetDevice = 194,
  HIP_API_ID_hipGetDeviceCount = 195,
  HIP_API_ID_hipIpcOpenEventHandle = 196,
  HIP_API_ID_NUMBER = 197,
